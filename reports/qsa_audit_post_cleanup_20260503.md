...
| `R004-duplicate-keys` | 🟡 1 🟢 1 | Duplicate natural keys in curated SHDB tables |
...
**58/58 (100.0%) rows with missing symbol**

Penalties without a symbol cannot drive per-stock signals.

Rows missing symbol: 58 of 58 (100.0%).
...
**81,848/109,764 (74.6%) rows with missing ticker_derived**

Filings without a derived ticker still have a CIK; the curated event_filing layer can resolve.

Rows missing ticker_derived: 81,848 of 109,764 (74.6%).

- affected rows: **81,848**
...
### `R004-duplicate-keys` — shdb.news_av_ticker_sentiment

**22,312 duplicate (symbol, obs_date) groups; 85,405 extra row(s)**

Natural key (symbol, obs_date) should be unique but 22,312 groups contain duplicates totalling 85,405 extra row(s).

- affected rows: **85,405**

**Sample:**

| symbol | obs_date | rows |
|---|---|---|
| JPM | 2026-03-12 | 119 |
| GOOGL | 2026-04-19 | 107 |
| NVDA | 2026-04-17 | 105 |
| MSFT | 2026-04-20 | 100 |
| JPM | 2026-05-01 | 97 |

_Recommendation:_ Confirm the curation builder uses ON CONFLICT DO UPDATE on the natural key; back-out the dup rows or add a unique index.
...
**SEC EDGAR filings: 259/305 MEF stocks (84.9%)**

Expected coverage: broad. 259 of 305 MEF universe stocks present in masd.sec_edgar_filing_events.ticker_derived.
...
**SEC enforcement: 4/305 MEF stocks (1.3%)**

Expected coverage: sparse_expected. 4 of 305 MEF universe stocks present in masd.secapi_regulatory_enforcement.symbol.
...
### `R004-duplicate-keys` — shdb.stock_news_1d

**1,112 duplicate (symbol, bar_date) groups; 2,477 extra row(s)**

Natural key (symbol, bar_date) should be unique but 1,112 groups contain duplicates totalling 2,477 extra row(s).

- affected rows: **2,477**

**Sample:**

| symbol | bar_date | rows |
|---|---|---|
| NVDA | 2026-03-17 | 23 |
| NVDA | 2026-02-18 | 17 |
| NVDA | 2026-03-25 | 17 |
