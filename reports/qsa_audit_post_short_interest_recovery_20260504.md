...
- 🛠  **Active defects**     — likely real issues, action recommended: **0** ✅
- 👀 **Monitoring**           — staleness / thin coverage; watch but not broken: **0** ✅
- 🗄  **Retired sources**     — formally retired; tracked here for visibility: **14**
- 📐 **Structural / by-design** — known correct NULLs (e.g. individual defendants): **5**
...
|---|---|---|
| `R003-missing-symbols` | 🟢 5 | Rows missing a symbol where one is required |
...
**7/55 (12.7%) actionable missing symbol; 46 structurally NULL**

Curated penalties; entity_type filter applied if column present.

Total rows: 55
NULL symbol: 53 (96.4%)
  • of which structurally correct (individuals / funds / private / agencies / system / other): 46 (83.6%)
  • of which actionable (entity_type=company or unknown): 7 (12.7% of total)
